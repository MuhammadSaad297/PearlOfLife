...
const memories_provider_1 = require("./memories.provider");
...
exports.MemoriesModule = MemoriesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [memories_service_1.MemoriesService, ...memories_provider_1.memoryFolderProvider],
        imports: [(0, common_1.forwardRef)(() => image_upload_module_1.ImageUploadModule)]
    })
], MemoriesModule);
